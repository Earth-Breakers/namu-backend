...
import static univ.earthbreaker.namu.core.api.character.CharacterBookResponse.BookSectionResponse;
import static univ.earthbreaker.namu.core.api.character.CharacterBookResponse.ProfileResponse;
...
public class CharacterResponseFixture {
	...
	public static final ProfileResponse ACQUIRED_PROFILE_RESPONSE
		= new ProfileResponse(CharacterFixture.CHARACTER_NO, CharacterFixture.TEST_CHARACTER_IMAGE_URL, true);
	public static final ProfileResponse NOT_ACQUIRED_PROFILE_RESPONSE
		= new ProfileResponse(0, CharacterFixture.TEST_CHARACTER_IMAGE_URL, false);
	...
	public static final MemberCharacter MEMBER_CHARACTER_1 = new MemberCharacter(1, CharacterFixture.MEMBER_NO, 1, CharacterFixture.END_NAMU_CHARACTER, true);
	public static final MemberCharacter MEMBER_CHARACTER_2 = new MemberCharacter(1, CharacterFixture.MEMBER_NO, 0, CharacterFixture.END_NAMU_CHARACTER, false);
	public static final MemberCharacter MEMBER_CHARACTER_3 = new MemberCharacter(1, CharacterFixture.MEMBER_NO, 1, CharacterFixture.END_PURIFY_NAMU_CHARACTER, true);
	public static final MemberCharacter MEMBER_CHARACTER_4 = new MemberCharacter(1, CharacterFixture.MEMBER_NO, 0, CharacterFixture.END_PURIFY_NAMU_CHARACTER, false);
	public static final MemberCharacter MEMBER_CHARACTER_5 = new MemberCharacter(1, CharacterFixture.MEMBER_NO, 1, CharacterFixture.END_VITALITY_NAMU_CHARACTER, true);
	public static final MemberCharacter MEMBER_CHARACTER_6 = new MemberCharacter(1, CharacterFixture.MEMBER_NO, 0, CharacterFixture.END_VITALITY_NAMU_CHARACTER, true);
