...
class RelatedPostRetrieveQueryTest {
	...
	private static Stream<Integer> provideSize() {
		return Stream.of(3, 11, null);
	}

	private static Stream<String> provideSuccessSortKey() {
		return Stream.of("", null, "id#DESC", "id#ASC", "id#desc", "id#asc");
	}

	private static Stream<String> provideFailSortKey() {
		return Stream.of("id,DESC", "asc#id");
	}

	private static Stream<Arguments> provideMemberNoAndMissionNoAndPage() {
		return Stream.of(
