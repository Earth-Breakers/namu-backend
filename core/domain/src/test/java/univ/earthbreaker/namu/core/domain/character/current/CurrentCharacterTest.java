...
import static univ.earthbreaker.namu.core.domain.character.CharacterFixture.FINAL_LEVEL_VALUE;
...
class CurrentCharacterTest {
	...
	void cannotLevelUp(CurrentCharacter currentCharacter, boolean expect) {
		// when
	...
	private static Stream<Arguments> provideCurrentCharacterAndExpect() {
		return Stream.of(
